...
from derived_relations import derived_relations_rewrite
...
def create_strat_map(assumes,asserts,macros):
    ...
    show_drs = True
    show_maps(show_strat_graph)
    derived_relations_rewrite(strat_map, arcs, show_strat_graph, show_drs)

# Show some information from the stratification graph. This is just for debugging.
